...
import type {
    TilecacheSourceSpecification
} from '../style-spec/types';

class TilecacheSource extends Evented implements Source {
    type: 'tilecache';
    id: string;
    minzoom: number;
    maxzoom: number;
    ...
    _loaded: boolean;
    _options: TilecacheSourceSpecification;
    _tileJSONRequest: ?Cancelable;

    constructor(id: string, options: TilecacheSourceSpecification, dispatcher: Dispatcher, eventedParent: Evented) {
        super();
        this.id = id;
...
export default TilecacheSource;
